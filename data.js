const profileData = {
  ...
  socials: [
    { name: "tiktok", url: "https://www.tiktok.com/@we.pattym", icon: "video" },
    { name: "instagram", url: "https://instagram.com", icon: "instagram" },
    { name: "whatsapp", url: "https://wa.me/", icon: "message-circle" }
  ],
  ...
  products: [
    {
      ...
      infoText: "Saber mais no site oficial"
    },
    {
      id: "magic-muuh",
      ...
      infoText: "Saiba mais no site oficial"
    }
  ]
};